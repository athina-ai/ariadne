...
def run_evaluation(loader: SummarizationLoader, config: dict) -> None:
    """
    Given a loader and configuration, initialize an evaluator and run the evaluation.
    """
